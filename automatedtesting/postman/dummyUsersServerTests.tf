...
# curl 127.0.0.1:8080/api/v1/employees -X POST -d '{"id": "4433", "first": "uncle", "last": "ben" }'
# curl 127.0.0.1:8080/api/v1/employees -X POST -d '{"id": "8877", "first": "john", "last": "wick" }'
# after terraform apply; should see 2 or 3 objects on the restServer.
# curl 127.0.0.1:8080/api/v1/employees | jq 
